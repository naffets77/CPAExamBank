...
$.pubty.log = function (logMessage) {
    if(this.debug)
        console.log("***************  " + logMessage)
}

$.pubty.pageSwap = function(inPageToHideId, inPageToShowId){
...
$.pubty.login = function(email, password, successCallback, failcallback){
    
    var self = this;


    var ph = new $.pubty.Utilities.PostHandler({
        service: "account", call: "login",
        params: { email: email, password: $.pubty.MD5(password) },
...
$.pubty.checkLogin = function (successCallback, failCallback) {
    var self = this;
...
$.pubty.validateForm = function(formElement){
...
$.pubty.validateField = function (Element, Validation) {
    var result = true;
    var message;
    ...
    switch (Validation) {
        ...
        case "Match":
            ...
            break;
        case "MatchPassword":
            result = $.pubty.MD5($.trim($(Element).val())) == $.trim($("#" + $(Element).attr("ValidationMatch")).val());
...
$.pubty.cycleButton = function(buttonElement, cycleName, originalName, fadeoutTime, cycleNameTime){
...
$.pubty.getDisplayNameById = function(languageId){
...
// Random Utils ( Should move to pubty.utlities.

$.pubty.MD5 = function (string) {
...
$.pubty.Utilities.PostHandler = function(options) {
